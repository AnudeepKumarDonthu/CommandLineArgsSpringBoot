...
<body>
	<a href="./pet_welcome.jsp"><span class="sclass"><font color="#87ceeb" size="6">Pet
			Peers</font></span></a>
	<div class="dclass">
	...
	<div class="dispclass">
		<table align="center" border="1" bordercolor="lightblue" width="900px"
			...
			<tr>
				<td><dispaly:table name="searchresults" cellspacing="0"
						...
						<dispaly:column property="petType" title="Pet Type"
							sortable="true"></dispaly:column>
						<dispaly:setProperty name="paging.banner.placement" value="bottom" />
					</dispaly:table></td>
			</tr>
		</table>
	</div>
	<div class="buydivclass">
		<c:forEach var="petDetails" items="${searchresults}"
			varStatus="counter">
			<table>
				<tr>
